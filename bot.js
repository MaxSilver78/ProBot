...
if (message.content.startsWith(prefix + 'heeelllppp')) { /// This is The DMS Code Send The Help In DMS // Code By NotGucci
    let pages = [`**
        ***__General orders__***
**
...
client.on('message', async message => {
    let amount = 17859558;
    if(message.content.startsWith(prefix + "dddaillly")) {
    if(message.author.bot) return;
...
client.on('message', message => {
    if (message.content.startsWith("G.bans")) {
        ...
        .then(bans => message.channel.send(`عدد الاشخاص المبندين **${bans.size}** `))
}
});
client.on('message', message => {
...
client.on('message', message => {
  ...
  if (message.author.id == 579377912780816410) return;


if (message.content.startsWith(prefix + 'playing')) {
if (message.author.id !== '579377912780816410') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
client.user.setGame(argresult);
...
if (message.content.startsWith(prefix + 'تغيير اسم')) {
if (message.author.id !== '579377912780816410') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
  client.user.setUsername(argresult).then
